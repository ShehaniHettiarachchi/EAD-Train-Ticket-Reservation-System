...
//Core Service -Reservation managment 
    ...
    public class ReservationService : IReservation
    {
        ...
        public Dictionary<int,string> CreateReservation(Reservation reservation)
        {
            ...
            if (reservation.Id != null)
            {
                ...
                {
                    returnCode.Add(100, "Your Reservation is confirmed and this cannot be updated/Cancelled");
                    return returnCode;
                }
                ...
                else
                {
                    ...
                    returnCode.Add(400, "Reservation Updated Successfully : " + reservation.Id);
                    return returnCode;
                }
            }
            else
            {
                ...
                {
                    returnCode.Add(100, "Reservation valid within 30 days from the booking date");
                    return returnCode;
                }
                else
                {
                    ...
                    if (validCount > 4)
                    {
                        returnCode.Add(200, "Maximum 4 reservation are available per reference ID");
                        return returnCode;
                    }
                    else 
                    {
                        ...
                        returnCode.Add(400, "Reservation Created Successfully : " + reservation.Id);
                        return returnCode;
        ...
        public Dictionary<int, string> CancelledReservation(string id , Reservation reservation)
        {
            ...
            if (reservation != null)
            {
                // Finding the existing reservation
